...
def abilenTopology():
    ...
    linkArray.append(
        net.addLink(s2, s5, delay='14ms', use_tbf=True, bw=4, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))
    linkArray.append(
        net.addLink(s2, s6, delay='14ms', use_tbf=True, bw=2, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))
    ...
    linkArray.append(
        net.addLink(s5, s6, delay='18ms', use_tbf=True, bw=3, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))
    linkArray.append(
        net.addLink(s5, s8, delay='20ms', use_tbf=True, bw=4, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))

    linkArray.append(
        net.addLink(s7, s6, delay='18ms', use_tbf=True, bw=4, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))
    linkArray.append(
        net.addLink(s7, s8, delay='20ms', use_tbf=True, bw=4, max_queue_size=queue_lenght, latency_ms=10000000,
                    burst=1000000))
    linkArray.append(
    ...
    for iteration in range(iterations):
        ...
        for loadLevel in loadLevels:
            ...
            start_new_thread(startIperf, (h1, h9, 2.5, 5001, timeTotal, loadLevel))
            start_new_thread(startIperf, (h2, h6, 1.75, 5001, timeTotal, loadLevel))
            start_new_thread(startIperf, (h3, h10, 1.75, 5001, timeTotal, loadLevel))
            start_new_thread(startIperf, (h4, h7, 2.5, 5001, timeTotal, loadLevel))
            start_new_thread(startIperf, (h5, h8, 2, 5001, timeTotal, loadLevel))
            i = i + 1
